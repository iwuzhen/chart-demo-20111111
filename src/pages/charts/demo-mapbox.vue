...
// mapboxgl.accessToken = 'sk.eyJ1IjoiaWRlciIsImEiOiJjbGF0Njdxcm8yOGF4M29xdjB4Mng4dTQzIn0.zyVWheDJEJFXrgQDhChljA'
mapboxgl.accessToken = 'pk.eyJ1IjoiaWRlciIsImEiOiJjaW1laWU3NXIwMTA5dmdtNmd3c2N1M3E4In0.i1Y6ezP5n0VlkUjUvGR_RA'
...
onMounted(async () => {
  const map = new mapboxgl.Map({
    ...
    style: 'mapbox://styles/ider/claruebfk001k15p8hinvqvlu', // 样式
    center: [154.294538, 35.860092], // 地图初始中心点 [经度, 维度]
    zoom: 2.4, // 地图初始缩放级别
    // projection: 'mercator', // 地图投影，自 v2.9.0 起支持 'globe'
  })
  ...
  const layer = new EChartsLayer('map', option)
  map.on('load', () => {
    map.addLayer(layer)
  })
...
<template>
  <div>
    ...
    <div id="map" class="echart-container" style="width: 1920px;height:1080px" />
  </div>
